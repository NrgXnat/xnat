/*
 * framework: org.nrg.framework.orm.hibernate.PrefixedTableNamingStrategy
...
/**
 * Old implementation of naming strategy.
 *
 * @deprecated  {@link org.hibernate.boot.model.naming.PhysicalNamingStrategy} should
 * be used instead after Hibernate 5. @{link org.nrg.xnat.configuration.OrmConfig} in
 * version 1.9.0 has been updated to use the new naming strategy.
 */
@Deprecated
