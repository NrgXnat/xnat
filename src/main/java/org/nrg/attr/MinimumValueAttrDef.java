/*
 * ExtAttr: org.nrg.attr.MinimumValueAttrDef
 ...
 *
 */
public class MinimumValueAttrDef<S,V,A extends Comparable<A>> extends AbstractExtAttrDef<S,V,A> {
    private final EvaluableAttrDef<S,V,A> base;
    
    public MinimumValueAttrDef(final EvaluableAttrDef<S,V,A> base) {
        super(base.getName(), base.getAttrs());
        this.base = base;
    }
    
    public static <S,V,A extends Comparable<A>> MinimumValueAttrDef<S,V,A> wrap(final EvaluableAttrDef<S,V,A> base) {
        return new MinimumValueAttrDef<S,V,A>(base);
    }
