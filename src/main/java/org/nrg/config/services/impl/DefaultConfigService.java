            ...
            protected void doInTransactionWithoutResult(final TransactionStatus status) {
                try {
                    ...
                    if (testForXnatProjectTable != null && testForXnatProjectTable) {
                        final long testForSiteRefs = _jdbcTemplate.queryForLong("SELECT COUNT(*) FROM xhbm_configuration WHERE scope IS NULL AND project IS NULL");
                        ...
                        final long testForEntityRefs = _jdbcTemplate.queryForLong("SELECT COUNT(*) FROM xhbm_configuration WHERE scope IS NULL AND (entity_id IS NULL OR entity_id = '')");
                        ...
                        final long testForProjectRefs = _jdbcTemplate.queryForLong("SELECT COUNT(*) FROM xhbm_configuration WHERE project IS NULL AND (entity_id IS NOT NULL AND entity_id != '')");
