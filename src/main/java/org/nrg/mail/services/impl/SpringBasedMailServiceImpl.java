...
public class SpringBasedMailServiceImpl extends AbstractMailServiceImpl {
    ...
    public void sendMessage(MailMessage message) throws MessagingException {
        if (StringUtils.isBlank(message.getHtml()) && StringUtils.isBlank(message.getOnBehalfOf()) &&
         ...
         * @param sender The sender service instance.
         */
    ...
    /**
        ...
        /**
         * Sends a MIME message using the mail service. You should create this message
         * by calling the {@link #getMimeMessage()} method.
