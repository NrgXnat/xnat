...
//	 * 
//	 */
//	public static XdatUsergroup SetGroupProperties(XdatUsergroup tempUser,	Map<String,? extends Object> props, String userName) throws Exception
//	{
//		final List<ElementSecurity> elements = ElementSecurity.GetSecureElements();
//		
//		final UserGroupI ug = Groups.getGroup(id);
//		ug.init(tempUser);
